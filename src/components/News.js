...
export class News extends Component {
  ...
  articles = [
    {
      ...
      url: "http://www.bbc.co.uk/sport/cricket/articles/c4gdpwy3k39o",
      urlToImage:
        "https://ichef.bbci.co.uk/ace/branded_sport/1200/cpsprodpb/ecf6/live/a235e0e0-5132-11f0-a2ff-17a82c2e8bc4.jpg",
      publishedAt: "2025-06-25T06:37:26.9062642Z",
      content:
        'Captain Ben Stokes said "it is a good job Test cricket is played over five days" following questions over his decision at the toss in England\'s epic victory over India.\r\nStokes opted to field despite… [+1365 chars]',
    },
    {
  ...
  constructor(props) {
    ...
    document.title = `NewsMoneey - ${this.capitalizeFirstLetter(this.props.category)}`;
  }

  async updateNews() {
    console.log("cdm");
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=23d863dfc03d4e5cbec6dfea11281e21&page=${this.state.page}&pageSize=${this.props.pageSize}`;
  ...
  handleNextClick = async () => {
    ...
    //   }&category=${
    //     this.props.category
    //   }&apiKey=23d863dfc03d4e5cbec6dfea11281e21&page=${
    //     this.state.page + 1
