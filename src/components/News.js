...
export class News extends Component {
  ...
  async componentDidMount() {
    console.log("cdm");
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=23d863dfc03d4e5cbec6dfea11281e21&page=1&pageSize=${this.props.pageSize}`;
  ...
  handleNextClick = async () => {
    ...
    if (
      ...
      let url = `https://newsapi.org/v2/top-headlines?country=${
        this.props.country
      }&category=${this.props.category}&apiKey=23d863dfc03d4e5cbec6dfea11281e21&page=${
        this.state.page + 1
